...
export function watchMatch(dataAPI, sectionWatchMatch) {
          ...
          <div class="infoMatch">
            ...
            <p>
              ${dataAPI[id].datetime.getDate() >= 0 && dataAPI[id].datetime.getDate() <= 9 ?
                ...
                `${dataAPI[id].datetime.getDate()}`}/${dataAPI[id].datetime.getMonth() + 1}/${dataAPI[id].datetime.getFullYear()}
            </p>
            <p>${dataAPI[id].datetime.getHours()}:${dataAPI[id].datetime.getMinutes() >= 0 && dataAPI[id].datetime.getMinutes() <= 9 ?
...
//# sourceMappingURL=watchMatch.js.map