...
export function handleWatch(data: newTeams[]) {
  const watchSection = document.querySelector<HTMLElement>('[data-watch]');
  if(watchSection) {
          ...
          <div class="infoMatch">
            ...
            <p>
              ${
                ...
                `${matchWatch.datetime.getDate()}`
              }/${matchWatch.datetime.getMonth() + 1}/${matchWatch.datetime.getFullYear()}
            </p>
            <p>${matchWatch.datetime.getHours()}:${
              matchWatch.datetime.getMinutes() >= 0 && matchWatch.datetime.getMinutes() <= 9 ?
